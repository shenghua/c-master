...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_resource "AlertView/Pod/Assets/AlertView.xib"
  install_resource "AlertView/Pod/Assets/Images.xcassets"
  ...
  install_resource "TutorMobileStreaming/Pod/Assets/LiveSessionType1_iPad.storyboard"
  install_resource "TutorMobileStreaming/Pod/Assets/LiveSessionType2_iPad.storyboard"
  install_resource "TutorMobileStreaming/Pod/Assets/Localizable.strings"
  install_resource "TutorMobileStreaming/Pod/Assets/RecordedSessionRoom_iPad.storyboard"
  install_resource "TutorMobileStreaming/Pod/Assets/SessionRoom.storyboard"
  install_resource "TutorMobileStreaming/Pod/Assets/Images.xcassets"
  install_resource "${BUILT_PRODUCTS_DIR}/AlertView.bundle"
  install_resource "${BUILT_PRODUCTS_DIR}/Fonts.bundle"
fi
